...
namespace Demo3.Controllers
{
    public class JobSeekersController : Controller
    {
        ...
        public JobSeekersController(ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneNumber,Gender,Address,Education,Experience,UserId")] JobSeeker jobSeeker)
        {
            if (id != jobSeeker.Id)
            {
                return NotFound();
